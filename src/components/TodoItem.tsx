...
export default function TodoItem({ todo, onToggle, onDelete, onEdit }: TodoItemProps) {
    ...
    return (
        ...
        peer-checked:border-emerald-500">
                    ...
                    <button
                        onClick={onDelete}
                        className="text-8xl text-black-500 hover:text-red-700 opacity-0 group-hover:opacity-100 transition-opacity text-lg sm:text-xl flex-shrink-0 w-6 h-6 flex items-center justify-center"
                    >
                        X
                    </button>
                </>
